...
In a series circuit with two resistors (R1 and R2), a multimeter will be used to measure the voltage and current across a known resistor (R2) as the input voltage is varied. Additionally, the resistances of the resistors will be determined using their color code and verified with a multimeter to be within the manufacturer's tolerance, using the following formula for percent error:
