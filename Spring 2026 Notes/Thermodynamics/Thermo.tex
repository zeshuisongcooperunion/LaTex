...
\[\boxed{P \, \vol = m R T}\]
While the ideal gas law is a useful approximation, it doesn't apply for steam and other gases near the vapor dome where the gas behaves non-ideally
\begin{center}
    \includegraphics[width=0.35\textwidth]{Ideal Gas Validity.png}
\end{center}
